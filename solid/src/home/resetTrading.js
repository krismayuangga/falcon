 function resetTradingOnClick() {
     ...
     document.getElementById('notifyme').insertAdjacentHTML("afterbegin", '<p style="color:#8c01a0">Auto Strat : ' + strategy + ' is paused. Press play to resume auto-trading.</p>');
     ...
     document.getElementById('notifyme').insertAdjacentHTML("afterbegin", '<p style="color:#8c01a0">Ready to place manual trade. Trade duration set to ' + convertedDuration + ' seconds.</p>');
     ...
     document.getElementById('notifyme').insertAdjacentHTML("afterbegin", '<p style="color:#8c01a0">bot has been reset, all data cleared, it will now start from initial stake @ 0.00 profit</p>');
